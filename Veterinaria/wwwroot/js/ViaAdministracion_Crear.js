...
$(document).ready(function () {
    ...
    $("#form").validate({
        ...
        messages: {
            Via_Administracion: "(Este campo obligatorio)"
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "codVia", "render": function (data, type, row, meta) {
...
function eliminar($id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            jQuery.ajax({
                url: "/ViaAdministracion/Eliminar" + "?id=" + $id,
                type: "GET",
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    if (data.resultado) {
                        ...
                        Swal.fire("Mensaje", "No se pudo eliminar la Via_Administracion", "warning")
                    }
                },
                error: function (error) {
                    console.log(error)
