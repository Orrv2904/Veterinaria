...
$(document).ready(function () {
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            { "data": "codBodega", "width": "10%" },
            { "data": "nombreBodega", "width": "20%" },
            {
            ...
            {
                "data": "codBodega", "render": function (data, type, row, meta) {
...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $("#txtid").val(json.codBodega);
        $("#txtNombreBodega").val(json.nombreBodega);
...
function Guardar() {
    ...
    if ($("#form").valid()) {
        ...
        var request = {
            objeto: {
                codBodega: parseInt($("#txtid").val()),
                nombreBodega: $("#txtNombreBodega").val(),
