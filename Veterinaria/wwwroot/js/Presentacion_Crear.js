...
$(document).ready(function () {
    ...
    $("#form").validate({
        ...
        messages: {
            Presentacion: "(Este campo obligatorio)"
    ...
    tabladata = $('#tbdata').DataTable({
        "ajax": {
            "url": "/Presentacion/Obtener",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "codPresentacion", "width": "10%" },
            { "data": "presentaciones", "width": "20%" },
            ...
            {
                "data": "codPresentacion", "render": function (data, type, row, meta) {
...
function abrirPopUpForm(json) {
    ...
    if (json != null) {
        ...
        $("#txtid").val(json.codPresentacion);
        $("#txtPresentaciones").val(json.presentaciones);
...
function Guardar()
{
    ...
    if ($("#form").valid()) {
        ...
        var request = {
            objeto: {
                codPresentacion: parseInt($("#txtid").val()),
                presentaciones: $("#txtPresentaciones").val(),
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.resultado) {
                        ...
                        Swal.fire("Mensaje", "No se pudo eliminar la Presentacion", "warning")
                    }
                },
                error: function (error) {
                    console.log(error)
