...
$(document).ready(function () {
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "codLaboratorio", "render": function (data, type, row, meta) {
...
function Guardar() {
    ...
    if ($("#form").valid()) {
        ...
        var request = {
            objeto: {
                codLaboratorio: parseInt($("#txtid").val()),
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.resultado) {
                        ...
                        Swal.fire("Mensaje", "No se pudo eliminar el Laboratorio", "warning")
                    }
                },
                error: function (error) {
                    console.log(error)
